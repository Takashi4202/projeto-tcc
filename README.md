...
*HTML: Estruturação da página e dos componentes principais, garantindo que a aplicação tenha uma base sólida e semântica.
*CSS: Estilo da página e criação de layouts personalizados, focando na clareza visual e responsividade.
*Tailwind CSS: Utilização dessa framework para acelerar o desenvolvimento de componentes visuais e garantir um design clean, flexível e responsivo.
